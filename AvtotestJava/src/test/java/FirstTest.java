...
public class FirstTest {
    ...
    public void setUp() throws Exception {
        ...
        driver.get(baseUrl);
        inputCardNumber = driver.findElement(By.id("input-card-number"));
    }
    ...
    @Test
    public void testPainmentConfirmed () throws Exception {
        driver.get(baseUrl);
        WebElement inputCardNumber = driver.findElement(By.id("input-card-number"));
        ...
        inputCardHolder.sendKeys("Vladimir Grigoryev");
        month.selectByValue("11");
        year.selectByIndex(10);
        inputCardCvc.sendKeys("013");
